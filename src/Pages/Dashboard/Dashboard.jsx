...
const Dashboard = () => {
  ...
  const getPayLink = () => {
    if(totalAmount == 5){
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 1})
      .then(res => {
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 2})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 3})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 4})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 5})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 6})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 7})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 8})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 9})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 10})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 11})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 12})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 13})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 14})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 15})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 16})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 17})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 18})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 19})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 20})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 21})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 22})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 23})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 24})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
      ...
      axiosPublic.post('https://itder.com/api/check-payment-template', {"template_number" : 25})
      .then(res => {
        if(res.data.status_code === 201){
          window.location.href = res.data.paymentLink
        }
